...
// Project02_SpicyUdon.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CProject02SpicyUdonApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CProject02SpicyUdonApp::OnAppAbout)
...
// CProject02SpicyUdonApp construction

CProject02SpicyUdonApp::CProject02SpicyUdonApp() noexcept
{
	...
	SetAppID(_T("Project02SpicyUdon.AppID.NoVersion"));

	// TODO: add construction code here,
	// Place all significant initialization in InitInstance
}

// The one and only CProject02SpicyUdonApp object

CProject02SpicyUdonApp theApp;


// CProject02SpicyUdonApp initialization

BOOL CProject02SpicyUdonApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_Project02SpicyUdonTYPE,
		RUNTIME_CLASS(CProject02SpicyUdonDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CProject02SpicyUdonView));
	if (!pDocTemplate)
		return FALSE;
...
int CProject02SpicyUdonApp::ExitInstance()
{
...
// CProject02SpicyUdonApp message handlers
...
void CProject02SpicyUdonApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
void CProject02SpicyUdonApp::OnFileOpen()
{
